...
images:
	for name in scheduler; do\
		docker buildx build -t "${IMAGE_PREFIX}/vc-$$name:v1.9.1-202603052208-12800f892" . -f ./installer/dockerfile/$$name/Dockerfile --output=type=${BUILDX_OUTPUT_TYPE} --platform ${DOCKER_PLATFORMS} --build-arg APK_MIRROR=${APK_MIRROR}; \
	done
