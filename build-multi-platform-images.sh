...
# 使用方法: 
#   ./build-multi-platform-images.sh registry.xxx.com v1.13.1-alpha                  # 构建所有组件
#   ./build-multi-platform-images.sh registry.xxx.com v1.13.1-alpha scheduler          # 只构建 scheduler
#   ./build-multi-platform-images.sh registry.xxx.com v1.13.1-alpha scheduler controller-manager  # 构建指定组件
